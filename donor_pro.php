  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
       ...
       <li><a href="donor_pro.php">Donor Profile</a></li> 
        <li><a href="donor_vwforum.php">Forum</a></li>
...
<div class="container-fluid bg-1 text-center">
  <div id="apDiv1">
      <h3 style="color:white";><b>Profile</b></h3>
  <iframe src="vw_donor_pro.php" width="800" height="450" frameborder="0"></iframe>
</div>
</div>
