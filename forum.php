...
<div class="container">
  <h1 style="color: red;">Forum post</h1>
  <h3 style="color: black;">Need Blood? The form below contains a text area for post (what you require):</h3>
  <form method="post" id="form1" action="addforum.php" onSubmit="alert('Your post has been submitted successfully. Thank you!');" >
